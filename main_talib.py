if __name__ == "__main__":
    ...
    from module_talib import test_sma, test_macd, test_bbands, test_sar, test_adx, test_bop
    ...
    print(price)
    opn, high, low, close = price["open"], price["high"], price["low"], price["close"]
